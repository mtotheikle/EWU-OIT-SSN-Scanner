...
extern "C"
{
	 ...
	 * patternCount: the count of each pattern, must be of size 2
	 *		patternCount[0] is for 9 digit patterns
	 *		patternCount[1] is for the 3-2-4 pattern
	 */
	DLL_EXPORT int ScanSSN(const char s[], int length, int *count, int *patternCount[])
	{
	 ...
	 * patternCount: used to count instances of specific patters, must be size 6
	 *		patternCount[0] is for Visa
	 *		patternCount[1] is for Master Card
	 *		patternCount[2] is for American Express
	 *		patternCount[3] is for Discover
	 *		patternCount[4] is for Diners Club
	 *		patternCount[5] is for JCB
	 */
	DLL_EXPORT int ScanCCN(char s[], int length, int *count, int *patternCount[])
	{
		int priority = NoNumFound;
		*count = 0;
		*patternCount[0] = 0;
